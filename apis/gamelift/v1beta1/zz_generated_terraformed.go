...
// GetTerraformResourceType returns Terraform resource type for this GameServerGroup
func (mg *GameServerGroup) GetTerraformResourceType() string {
	return "aws_gamelift_game_server_group"
}

// GetConnectionDetailsMapping for this GameServerGroup
func (tr *GameServerGroup) GetConnectionDetailsMapping() map[string]string {
	return nil
}

// GetObservation of this GameServerGroup
func (tr *GameServerGroup) GetObservation() (map[string]any, error) {
	o, err := json.TFParser.Marshal(tr.Status.AtProvider)
	if err != nil {
		return nil, err
	}
...
// SetObservation for this GameServerGroup
func (tr *GameServerGroup) SetObservation(obs map[string]any) error {
	p, err := json.TFParser.Marshal(obs)
	if err != nil {
		return err
	}
...
// GetID returns ID of underlying Terraform resource of this GameServerGroup
func (tr *GameServerGroup) GetID() string {
	if tr.Status.AtProvider.ID == nil {
		return ""
	}
	return *tr.Status.AtProvider.ID
...
// GetParameters of this GameServerGroup
func (tr *GameServerGroup) GetParameters() (map[string]any, error) {
	p, err := json.TFParser.Marshal(tr.Spec.ForProvider)
	if err != nil {
		return nil, err
	}
...
// SetParameters for this GameServerGroup
func (tr *GameServerGroup) SetParameters(params map[string]any) error {
	p, err := json.TFParser.Marshal(params)
	if err != nil {
		return err
	}
...
// LateInitialize this GameServerGroup using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *GameServerGroup) LateInitialize(attrs []byte) (bool, error) {
	params := &GameServerGroupParameters{}
	if err := json.TFParser.Unmarshal(attrs, params); err != nil {
		return false, errors.Wrap(err, "failed to unmarshal Terraform state parameters for late-initialization")
	}
	opts := []resource.GenericLateInitializerOption{resource.WithZeroValueJSONOmitEmptyFilter(resource.CNameWildcard)}
...
// GetTerraformSchemaVersion returns the associated Terraform schema version
func (tr *GameServerGroup) GetTerraformSchemaVersion() int {
	return 0
}
